...
public class PlayerInteractListener extends EventListener implements Listener {
	public PlayerInteractListener(VanillaPlugin plugin) {
		super(plugin);
	}
	...
	public void onPlayerInteract(final PlayerInteractEvent event) {
		...
		} else if (event.getAction() == Action.RIGHT_CLICK_BLOCK && VanillaPlugin.BED_BLOCKS.contains(clickedBlock.getType())) {
