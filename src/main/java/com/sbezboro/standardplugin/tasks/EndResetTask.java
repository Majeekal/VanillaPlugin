...
public class EndResetTask extends BaseTask {
	...
	public EndResetTask(VanillaPlugin plugin, World overworld) {
		super(plugin);
	...
	@Override
	public void run() {
		VanillaPlugin.broadcast(String.format("%s%sAttention! The end is resetting!", ChatColor.BLUE, ChatColor.BOLD));
		...
		VanillaPlugin.broadcast(String.format("%s%sThe end has reset!", ChatColor.BLUE, ChatColor.BOLD));
	}
