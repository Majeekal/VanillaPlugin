...
public class VanillaPlugin extends JavaPlugin {
	...
	public static VanillaPlugin getPlugin() {
		return instance;
	}
	...
	private void registerCommands() {
		...
		commands.add(new VanillaCommand(this));
	...
	// ------
	public static void playerBroadcast(Player sender, final String message, boolean console) {
	...
	public static void playerBroadcast(Player sender, final String message) {
		playerBroadcast(sender, message, true);
	}

	public static void broadcast(String message, boolean console) {
		playerBroadcast(null, message, console);
	}
	...
	public boolean isEndResetEnabled() {
		return config.isEndResetEnabled();
	}
