...
public abstract class SubCommand implements Comparable<SubCommand> {
	...
	public SubCommand(VanillaPlugin plugin, BaseCommand command, String commandName) {
		this.plugin = plugin;
	...
	public SubCommand(VanillaPlugin plugin, BaseCommand command, String commandName, List<String> alternatives) {
		this.plugin = plugin;
		this.command = command;
		this.commandName = commandName;
