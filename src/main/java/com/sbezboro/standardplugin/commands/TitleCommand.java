...
public class TitleCommand extends BaseCommand {
	...
	public TitleCommand(VanillaPlugin plugin) {
		...
		if (args[0].equalsIgnoreCase("create")) {
			...
			if (args[0].equalsIgnoreCase("add")) {
				...
				if (player.hasTitle(titleName)) {
					...
					VanillaPlugin.broadcast(ChatColor.AQUA + player.getDisplayName() + ChatColor.RESET + " now has the title " + ChatColor.AQUA
				...
				if (player.hasTitle(titleName)) {
					...
					VanillaPlugin.broadcast(ChatColor.AQUA + player.getDisplayName() + ChatColor.RESET + " no longer has the title " + ChatColor.AQUA
							+ title.getDisplayName());
				} else {
